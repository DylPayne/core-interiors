        ...
        <div className="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-3xl tracking-tight font-bold text-gray-900 sm:text-3xl md:text-4xl">
                <span className="block xl:inline font-serif">
                  Welcome to Core Quality
                </span>{" "}
                <span className="block text-maroon xl:inline font-serif">
                  Kitchen, Cabinets and Interiors
                </span>
              </h1>
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                ...
                manufacture and installation. Only materials of excellent
                quality and from reputable suppliers are used. We also offer a
                “one stop renovation service”meaning we will appoint and manage
                all other trades like plumbers, builders and electricians taking
                the hassle and stress out of your home or kitchen alteration.
              </p>
