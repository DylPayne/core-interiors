    ...
    <div className="py-16 bg-gray-50">
      <div className="container mx-auto px-4 flex flex-col lg:items-center justify-between lg:flex-row">
        <div className="mb-14 xl:mb-0">
          ...
          <button className="hidden md:block w-full sm:w-auto mt-12 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-maroon items-start justify-center sm:justify-start px-8 py-4 bg-maroon hover:bg-maroon-dark rounded text-base font-medium leading-none text-center text-white">
